...
This appendix contains the code used to train CoNNOR. Before presenting the code, it will helpful to describe the structure of the full project directory .
