...
calc_heatmap(imgs[which(grepl("chevron-circle", imgs))], loaded_model) %>% create_composite()
@

<<corks-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6>>=
calc_heatmap(imgs[which(grepl("corks", imgs))], loaded_model) %>% create_composite()
@

<<quad-triangle-hexagon-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6>>=
calc_heatmap(imgs[which(grepl("quad-triangle-polygon", imgs))], loaded_model) %>% create_composite()
@

<<star-quad-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6>>=
calc_heatmap(imgs[which(grepl("star-quad", imgs))], loaded_model) %>% create_composite()
@


<<text-seychelles-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6>>=
calc_heatmap(imgs[which(grepl("text", imgs))], loaded_model) %>% create_composite()
@

<<bowtie-star-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6>>=
calc_heatmap(imgs[which(grepl("bowtie-star", imgs))], loaded_model) %>% create_composite()
@
