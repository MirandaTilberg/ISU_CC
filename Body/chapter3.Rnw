...
In several of the model consistency case studies presented, color contrast was identified as a possible reason for poor feature identification. There are automatic ways to adjust the contrast of photos, enhancing CoNNOR's ability to notice details. \autoref{fig:auto-color-balance} shows the original predictions of previous cases with low contrast paired with predictions of the images after adjusting for contrast. While the predictions did not change drastically, contrast correction does not seem to worsen predictions, and the predictions of the UGG and the New Balance logos show significant improvement.
...
<<chevron-circle-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6, fig.scap = "Heatmaps of image containing chevrons and circles.", fig.cap = "Heatmaps of outsole image containing chevrons and circles.">>=
