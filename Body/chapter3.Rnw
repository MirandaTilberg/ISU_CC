...
<<roc-code, fig.width = 5, fig.height = 5, out.width = ".5\\textwidth", fig.cap = "ROC Curve">>=
library(pROC)
...
<<confusion_matrix, fig.width = 9, fig.height = 8, out.width = "\\textwidth", fig.cap = "", dpi = 600>>=
...
<<generic-chevron, fig.width = 11, fig.height = 11, out.width = "\\textwidth", fig.cap = "This one is interesting, but not *that* bad all things considered...", fig.scap = "", dpi = 600>>=
chevron2 <- list.files(here::here("Images", "chapter3", "test-imgs", "generic-chevron"), full.names = T)
pred_prob_plot(chevron2, loaded_model)
@

<<generic-text-line, fig.width = 11, fig.height = 6, out.width = "\\textwidth", fig.cap = "This one is interesting, but not *that* bad all things considered...", fig.scap = "", dpi = 600>>=
...
<<generic-triangle, fig.width = 11, fig.height = 7, out.width = "\\textwidth", fig.cap = "Wow, this one sucks.", fig.scap = "", dpi = 600>>=
...
<<nb_logo, fig.width = 11, fig.height = 11, out.width = "\\textwidth", fig.cap = "", fig.scap = "Features detected in the New Balance shoe logo across different shoe models.", dpi = 600>>=
nb_logo <- list.files(here::here("Images", "chapter3", "test-imgs", "nb-logo"), full.names = T)
pred_prob_plot(nb_logo, loaded_model)
@


<<nike, fig.width = 11, fig.height = 9, out.width = "\\textwidth", fig.cap = "", fig.scap = "Features detected in a rounded triangle across different color soles. The bottom figure, which is of a black sole and has very little contrast, is poorly recognized by the model. The image immediately above it is an automatically color-adjusted version of the same image, which has much better performance for recognition of a circular shape. ", dpi = 600>>=
...
<<chevron, fig.width = 11, fig.height = 9, out.width = "\\textwidth", fig.cap = "", fig.scap = "Features detected in a chevron pattern across different colors.", dpi = 600>>=
