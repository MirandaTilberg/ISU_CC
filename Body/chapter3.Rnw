...
\autoref{fig:chevron-circle-heatmap}
\autoref{fig:corks-heatmap}
...
<<corks-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6, fig.scap = "Heatmaps of an image containing none of the target classes.", fig.cap = "This outsole shows repeated outlines of corks, which do not fall into any of the nine classes; the convex corners where the corks overlap are predicted to be stars, and the round edges lead to predictions of circles.">>=
