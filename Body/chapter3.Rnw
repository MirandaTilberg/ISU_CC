...
<<nb_logo, fig.width = 12, fig.height = 23, out.width = ".6\\textwidth", fig.cap = "", fig.scap = "Features detected in the UGG shoe logo across different shoe models", dpi = 600>>=
nb_logo <- list.files(here::here("Images", "chapter3", "test-imgs", "nb-logo"), full.names = T)
pred_prob_plot(nb_logo, loaded_model)
@
