...
<<nike, fig.width = 12, fig.height = 23, out.width = ".6\\textwidth", fig.cap = "", fig.scap = "Features detected in the UGG shoe logo across different shoe models", dpi = 600>>=
