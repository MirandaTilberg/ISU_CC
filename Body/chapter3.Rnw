...
<<chevron-circle-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6, fig.cap = "Caption">>=
knitr::include_graphics(heatmaps[grepl("chevron-circle", heatmaps)])
@

<<corks-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6, fig.cap = "Caption">>=
knitr::include_graphics(heatmaps[grepl("corks", heatmaps)])
@

<<quad-triangle-hexagon-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6, fig.cap = "Caption">>=
knitr::include_graphics(heatmaps[grepl("quad-triangle-polygon", heatmaps)])
@

<<star-quad-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6, fig.cap = "Caption">>=
knitr::include_graphics(heatmaps[grepl("star-quad", heatmaps)])
@


<<text-seychelles-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6, fig.cap = "Caption">>=
knitr::include_graphics(heatmaps[grepl("text", heatmaps)])
@

<<bowtie-star-heatmap, eval = T, out.width = ".95\\textwidth", fig.width = 8, fig.height = 6, fig.cap = "Caption">>=
