...
<<litReview, child='Body/chapter1.Rnw'>>=
@
\chaptocbreak
<<litReview, child='Body/chapter2.Rnw'>>=
@
\chaptocbreak
<<litReview, child='Body/chapter3.Rnw'>>=
@
\chaptocbreak
<<litReview, child='Body/chapter4.Rnw'>>=
@
%\chaptocbreak
%<<litReview, child='Body/chapter5.Rnw'>>=
%@
\include{Reference/bibtex}
<<litReview, child='Appendix/appendix1.Rnw'>>=
@
\chaptocbreak
<<litReview, child='Appendix/appendix2.Rnw'>>=
@
\include{Reference/bibtex}
