...
\noindent\fbox{\parbox{.98\textwidth}{\svp{I took a stab at re-phrasing this paragraph - all the thoughts are yours, I've just tweaked the language a bit and added things you didn't have - like the citation/stat from the conversation with Leslie Hammer. If you agree with the changes, go ahead and remove the \textbackslash{}svp\{\} highlights - those are there to draw your attention to the changed text. Then delete this box/paragraph :)}}}
...
\bibliography{refs}
\end{document}
>>>>>>> b16d876cd9dac464360bf9646399a4d9747f61cb
