...
- Fix pooling LaTeX <br/>
- Format backprop <br/>
- Fix loss notation?
- Citations? <br/>
- Fix augmentation images <br/>
- Add pred prob images <br/>
- CoNNOR's classifier: 32768 to 256 to 9 (paper?) <br/>
- Rename heatmaps in paper to Class Activation Map? <br/>
- Get DC heatmap <br/>
...
& \text{ with window } w, \text{ and stride } s \end{align}
...
- For a single input image $x^{(0)}$ with true labels $\textbf{y} \in \left\{0,1\right\}^C$ and prediction $\mathbf{\hat{p}} \in [0,1]^C$,<br/>
...
- Deep CNNs have millions of parameters. <br/><br/>
  - E.g., VGG16 model base has 14,714,688 trainable parameters <br/><br/>
- Once trained, model layers can be split apart and used separately <br/><br/>
- Using the existing model base ("eyes") and retraining the classifier ("brain") brings the required number of images down from millions to only thousands
...
#### VGG16
- Pre-trained CNN <br/><br/> 
    - Trained on 1.3 million images from ImageNet <br/><br/> 
    - Simple structure
