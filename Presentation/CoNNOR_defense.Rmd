...
- Make, model, tread pattern, size, shoe type<br/><br/>
- Cannot be used for identification of an individual<br/><br/>
- Used for exclusion<br/><br/>
...
plot_deepviz_arrows(c(20, 15, 9), r = .1)
```
---
class:primary
# Dropout

```{r dropout, out.width = "75%", fig.width = 10, fig.height = 5, fig.align = "center"}
#plot_deepviz_dropout(n = c(6,6,3), rm_nodes = c(3,4,6,8,10,11), cross_out = T)
set.seed(1)
plot_deepviz_dropout(n = c(20,15,9), rm_nodes = sample(1:35, 15), cross_out = T)
```
